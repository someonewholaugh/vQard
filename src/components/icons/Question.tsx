...
export const Question = ({ color = 'white' }: IconProps) => {
  return (
    <svg className="size-20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        fill={color}
      />
      <path d="M10 13H7V16H10V13Z" fill={color} />
    </svg>
  );
};
